...
const testimonials = [
    {
        name: 'Mohinee Chauhan',
        role: 'Frontend Web Developer',
        content:
            'This quiz web app is built for fun with learning. It can allow the user to select the criteria for their quiz from a list of options. The user can then proceed to answer the questions in the quiz and their performance will be tracked and shown in the scoreboard. Moreover, the app can be designed to be responsive and user-friendly.',
